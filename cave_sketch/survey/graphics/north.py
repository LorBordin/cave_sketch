...
def _add_north_arrow(
    ...
    if rotation_deg !=0: 
        x_o, y_o = rotate_points((x_o, y_o), center, rotation_deg)
        x_left, y_left = rotate_points((x_left, y_left), center, rotation_deg)
        x_top, y_top = rotate_points((x_top, y_top), center, rotation_deg)
        x_right, y_right = rotate_points((x_right, y_right), center, rotation_deg)
